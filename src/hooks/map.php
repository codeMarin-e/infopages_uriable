...
return [
    ...
    implode(DIRECTORY_SEPARATOR, [ base_path(), 'app', 'Http', 'Requests', 'Admin', 'InfopageRequest.php']) => [
        ...
        "// @HOOK_INFOPAGE_REQUEST_MESSAGES" => implode(DIRECTORY_SEPARATOR, [__DIR__, 'HOOK_INFOPAGE_REQUEST_MESSAGES.php']),
        "// @HOOK_INFOPAGE_REQUEST_AFTER_VALIDATED" => implode(DIRECTORY_SEPARATOR, [__DIR__, 'HOOK_INFOPAGE_REQUEST_AFTER_VALIDATED.php']),
    ],
];
